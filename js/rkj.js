...
// LIST SONGS
const listSongs = document.querySelectorAll(".title-list-rkj p");

let songIndex = 0;
// CREATE CONTENT LOAD
window.addEventListener("DOMContentLoaded", () => {
  const item = musicRkj[songIndex];
...
nextBtn.addEventListener("click", () => {
  ...
  if (songIndex > musicRkj.length - 1) {
    songIndex = 0;
  }
