...
// LIST SONGS
const listSongs = document.querySelectorAll(".title-list-twt p");

let songIndex = 0;
// CREATE CONTENT LOAD
window.addEventListener("DOMContentLoaded", () => {
  const item = musicTwt[songIndex];
...
nextBtn.addEventListener("click", () => {
  ...
  if (songIndex > musicTwt.length - 1) {
    songIndex = 0;
  }
